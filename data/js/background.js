...
(function () {
    ...
    chrome.contextMenus.create({'title': 'Send AVN', 'contexts': ['page'], 'onclick': menuOnClick});
    ...
    chrome.runtime.onMessage.addListener(function (request) {
        if (request.address) {
            chrome.tabs.create({url: preferences.getExplorer() + '/getaddress/?address=' + request.address});
        }
    });
