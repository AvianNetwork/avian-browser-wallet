    ...
    $('.bitcoin-address').hover(function () {
        ...
        if (!openPopups[address]) {
            ...
            util.iframe('hoverpopup.html').then(function (iframe) {
                ...
                // Avian API
                util.get(preferences.getSite() + '/balance/' + address).then(function (response) {
                    popUpBalance = response;

                });
                util.get(preferences.getSite() + '/unspent/' + address).then(function (response) {
                ...
                $iframe.find('#infoButton').click(function () {
                    ...
                    if (typeof chrome !== 'undefined') {
                        ...
                        self.port.emit('openTab', preferences.getExplorer() + '/address/?address=' + address);
                    }
                });
